              ...
              <div key={player.id} className="opponent-player">
                ...
                <div className="signature-heroes">
                  {player.signatureHeroes.slice(0, 3).map(heroId => (
                    <img 
                      key={heroId}
                      src={`/heroes/${getHeroImageName(heroId)}.png`}
                      alt=""
                      className="opponent-hero-icon"
                      title={`${player.name} 的擅长英雄`}
                      onError={(e) => {
...
// 辅助函数：根据英雄ID获取图片名称
function getHeroImageName(heroId: number): string {
  const heroNames: Record<number, string> = {
    ...
    21: 'windrunner', 22: 'zuus', 23: 'kunkka', 25: 'lina', 26: 'lion', 27: 'shadow_shaman',
    28: 'slardar', 29: 'tidehunter', 30: 'witch_doctor', 31: 'lich', 32: 'riki',
    33: 'enigma', 34: 'tinker', 35: 'sniper', 36: 'necrolyte', 37: 'warlock',
    38: 'beastmaster', 39: 'queenofpain', 40: 'venomancer', 41: 'faceless_void',
    ...
    66: 'chen', 67: 'spectre', 68: 'ancient_apparition', 69: 'doom_bringer',
    70: 'ursa', 71: 'spirit_breaker', 72: 'gyrocopter', 73: 'alchemist', 74: 'invoker',
    75: 'silencer', 76: 'obsidian_destroyer', 77: 'lycan', 78: 'brewmaster',
    79: 'shadow_demon', 80: 'lone_druid', 81: 'chaos_knight', 82: 'meepo',
    ...
    106: 'ember_spirit', 107: 'earth_spirit', 108: 'abyssal_underlord', 109: 'terrorblade',
    110: 'phoenix', 111: 'oracle', 112: 'winter_wyvern', 113: 'arc_warden',
    114: 'monkey_king', 119: 'dark_willow', 120: 'pangolier', 121: 'grimstroke',
    123: 'hoodwink', 126: 'void_spirit', 128: 'snapfire', 129: 'mars',
    131: 'ringmaster', 135: 'dawnbreaker', 136: 'marci', 137: 'primal_beast',
    138: 'muerta', 145: 'kez', 155: 'largo'
  };
  return heroNames[heroId] || 'default';
}
